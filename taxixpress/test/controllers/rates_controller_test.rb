...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { amount: @rate.amount, destination: @rate.destination, id_rate: @rate.id_rate, origin: @rate.origin }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { amount: @rate.amount, destination: @rate.destination, id_rate: @rate.id_rate, origin: @rate.origin }
    assert_redirected_to rate_path(assigns(:rate))
  end
